...
void PrintUsage() {
    std::cerr << "Usage:\n"
              ...
              << "      [--output-candidates out.pmg_candidates.json] [--min-window-speed S]\n"
              << "      (--min-window-speed >0 drops near-standing windows, native units/s;\n"
              << "       0 = legacy loop-seam-only ranking)\n"
